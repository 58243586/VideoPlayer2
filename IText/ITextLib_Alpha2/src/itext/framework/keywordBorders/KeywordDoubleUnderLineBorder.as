    ...
    public class KeywordDoubleUnderLineBorder extends UIComponent
    {
        ...
        public function KeywordDoubleUnderLineBorder(color:uint, beginIndex:int, endIndex:int, ta:TextArea)
        {
            ...
            else
            {
                ...
                this.graphics.moveTo(0, rectStart.height + offsetY + offsetY1);
                this.graphics.lineTo(startLineLastIndexRect.x + startLineLastIndexRect.width - rectStart.x, rectStart.height + offsetY + offsetY1);
                ...
                for (var i:int = startLineIndex + 1; i < endLineIndex; i++)
                {
					...
					this.graphics.moveTo(lineFirstIndexRect.x - rectStart.x, lineFirstIndexRect.y + lineFirstIndexRect.height - rectStart.y + offsetY + offsetY1);
					this.graphics.lineTo(lineLastIndexRect.x + lineLastIndexRect.width - rectStart.x, lineFirstIndexRect.y + lineFirstIndexRect.height - rectStart.y + offsetY + offsetY1);
                }
				...
				this.graphics.moveTo(endLineFirstIndexRect.x - rectStart.x, rectEnd.y + rectEnd.height - rectStart.y + offsetY + offsetY1);
